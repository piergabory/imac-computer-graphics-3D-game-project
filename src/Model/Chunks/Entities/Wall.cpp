...
namespace GameModel {
    ...
    void Wall::loadObject() {
        s_entityObject = std::unique_ptr<GraphicsEngine::Object3D>(makeObject("assets/models/road_wall.obj", "assets/textures/road.png", "shaders/perspective.vs.glsl", "shaders/lighting.fs.glsl"));
    }
