...
namespace GameModel
{
    ...
    void Jump::loadObject() {
        s_entityObject = std::unique_ptr<GraphicsEngine::Object3D>(makeObject("assets/models/road_jump.obj", "assets/textures/wall.png", "shaders/perspective.vs.glsl", "shaders/flatTexture.fs.glsl"));
    }
}
