...
namespace GraphicsEngine
{
    ...
    void Object::setVertexArray(const std::vector<Vertex> &vertices) const {
        ...
        glVertexAttribPointer(VERTEX_ATTR_POSITION, 3, GL_FLOAT, GL_FALSE, sizeof(GraphicsEngine::Vertex), 0);
        glVertexAttribPointer(VERTEX_ATTR_NORMAL, 3, GL_FLOAT, GL_FALSE, sizeof(GraphicsEngine::Vertex), (const void*) (1 * sizeof(glm::vec3)));
